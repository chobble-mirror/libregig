module ApplicationHelper
  ...
  def close_button(key)
    label_for = "banneralert-#{key}"
    svg_xmlns = "http://www.w3.org/2000/svg"
    close_path = "M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.819l-2.651 " \
    ...
    tag.label class: "close", style: "width:30px", for: label_for do
      tag.svg class: "fill-current h-6 w-6", role: "button",
              xmlns: svg_xmlns, viewBox: "0 0 20 20" do
        concat(tag.title("Close"))
        concat(tag.path(d: close_path))
      end
    end
  end
end
