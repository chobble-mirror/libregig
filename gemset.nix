{
  ...
  ffi = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-Jvaw29EQHm/8CdPKZAsqIYQMxScxrYp97Z+4nl+w/Dk=";
      type = "gem";
    };
    version = "1.17.1";
  };
  ...
  html2haml = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "09w112pf7qgyphxvjm835vkib7lc3s33aasw7gy455k06bsym1xm";
      type = "gem";
    };
    version = "2.3.0";
  };
  ...
  nokogiri = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-k3kc+zMYb+B3654bimhVtWIeMo+B9WUzRXL6OYNm+L8=";
      type = "gem";
    };
    version = "1.18.2";
  };
  ...
  sqlite3 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-h/oANuY2nD88/sp0mGXCsrY2SdOxeyI9GTmo7tSEGms=";
      type = "gem";
    };
    version = "2.5.0";
  };
  standard = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0a1dhl5d1jch8hg8p7vyrkizz6yx3jqyzr7pdr8yhv6lrikn5qsh";
      type = "gem";
    };
    version = "1.44.0";
  };
